// TODO: Given a positive integer value "N", return the largest numeric palindrome (if one exists) that can be produced
// by multiplying two N-digit numbers, else return 0 (if one doesn't exist)
